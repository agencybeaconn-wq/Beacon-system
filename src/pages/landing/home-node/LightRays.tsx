/**
 * LightRays — background WebGL de feixes de luz (React Bits, adaptado pra TSX).
 * Fonte: github.com/DavidHDev/react-bits (Backgrounds/LightRays), cor fixa branca NODE.
 * Respeita prefers-reduced-motion (não inicializa WebGL).
 */
...
void main() {
  ...
  gl_FragColor  = color;
    ...
    return <div ref={containerRef} className={className} style={{ position: 'absolute', inset: 0, pointerEvents: 'none', overflow: 'hidden' }} />;
}
